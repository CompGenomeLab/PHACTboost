...
def get_protein_pos(chr_pos_dict,canonical_transcripts_dict,mapped_file,not_found_file):
    ...
    with open(mapped_file,'w') as f:
        #f.write("chrm" + "\t" + "position" + "\t" + "ref_nuc"+ "\t" +"alt_nuc"+ "\t" +"original_cds"+ "\t" +"alt_cds"+ "\t" +"original_protein_id"+ "\t" +"original_protein_seq"+ "\t" +"alt_protein_position"+ "\t" +"alt_amino_acid"+"\n")
            ...
            for alternation in v:
                ...
                try:
                    ...
                    if "*" in alt_aa:
                        ...
                        #f.write(chrm + "\t" + pos + "\t" + ref_nuc+ "\t" + alt_nuc + "\t" + original_cds + "\t" + alt_cds + "\t" + original_protein_id +  "\t" + original_protein_seq + "\t" + str(alt_protein_pos) + "\t" + alt_aa+"\n")
